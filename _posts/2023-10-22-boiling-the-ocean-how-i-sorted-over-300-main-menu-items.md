...
1. GENERAL RESOURCES (i.e. The Catalog)
   ![general resources]({{site.baseurl}}/assets/img/boiling-the-ocean/general-resources.png)

2. LIBRARY INFORMATION (i.e. Everything Else)
   ![library information]({{site.baseurl}}/assets/img/boiling-the-ocean/library-information.png)

There were also various minor categories, most of which fell under:

1. Get Involved (i.e. volunteering/working at the library)
   ![get involved]({{site.baseurl}}/assets/img/boiling-the-ocean/get-involved.png)

2. Business and Careers (i.e. volunteering/working elsewhere)
   ![business and careers]({{site.baseurl}}/assets/img/boiling-the-ocean/business-and-careers.png)

3. Events
   ![events]({{site.baseurl}}/assets/img/boiling-the-ocean/events.png)

Last, here are the disagreements rhat fell outside of the above categories, and by how much:

![similarity disagreements]({{site.baseurl}}/assets/img/boiling-the-ocean/similarity-disagreements.png)
...
![Giant poster-sized printout]({{site.baseurl}}/assets/img/boiling-the-ocean/giant-printout.jpg)
...
![Card split]({{site.baseurl}}/assets/img/boiling-the-ocean/card-split.jpg)
...
![Gephi displaying a force directed graph]({{site.baseurl}}/assets/img/tools/gephi.png)
...
![Current Richland Library Menu]({{site.baseurl}}/assets/img/boiling-the-ocean/current-menu.png)
